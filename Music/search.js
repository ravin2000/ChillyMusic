...
module.exports = {
  name: "search",
  description: "Keresse meg és válassza ki a lejátszani kívánt zenét.",
  aliases: ["find"],
  cooldown: 3,
  edesc: `Írja be ezt a parancsot, és megtalálja a zene első 5 találatát!\nHasználata: ${PREFIX}search <ZENE NEVE | URL>`,
...
async execute(message,args,client) {
    ...
    if (!args.length)
      return attentionembed(message,`Használata: ${message.client.prefix}${module.exports.name} <Video Neve>`)
