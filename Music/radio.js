...
module.exports = {
  name: "radio",
  description: "Játssz egy rádióállomást.",
  cooldown: 3,
  edesc: `Írja be ezt a parancsot a rádió élő közvetítésének lejátszásához!\nHasználata: ${PREFIX}radio <1-34>`,
...
message.channel.send(new MessageEmbed().setColor("YELLOW")
.setDescription(`**💢 Keresés 🔍 \`${Radiostations[i-1].split(" ")[0]}\`**`));
//mute yourself
